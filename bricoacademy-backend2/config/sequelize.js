...
logMensaje("seq DBNAME config:", config.db.name);
logMensaje("seq DBHOST config:", config.db.host);
logMensaje("seq DBUSER config:", config.db.user);
logMensaje("seq DBPORT config:", config.db.port);
